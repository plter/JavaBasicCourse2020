...
public class Safe_Test {
    ...
    public static void main(String[] args)
    {
        ...
        Person_Runnable p1 = new Person_Runnable(lm);
        Thread th1 = new Thread(p1);
        th1.start();

        Person_Runnable p2 = new Person_Runnable(lm);
        Thread th2 = new Thread(p2);
        th2.start();

        Person_Runnable p3 = new Person_Runnable(lm);
        Thread th3 = new Thread(p3);
        th3.start();

        Person_Runnable p4 = new Person_Runnable(lm);
        Thread th4 = new Thread(p4);
        th4.start();

        Person_Runnable p5 = new Person_Runnable(lm);
